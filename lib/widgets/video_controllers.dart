...
//   final bool enableAutoIcon;
//   final bool isHdFound;
//   final bool isGeneral;
//   final void Function()? onTapHd;
//   final void Function()? onTapAuto;
//
//   const VideoPlayerMaterialControls({
//     Key? key,
//     required this.onControlsVisibilityChanged,
//     required this.controlsConfiguration,
//     required this.hdIcon,
//     required this.isHdFound,
//      this.isGeneral=false,
//     this.onTapHd,
//     required this.autoIcon, this.onTapAuto, required this.enableAutoIcon,
//   }) : super(key: key);
//
//   @override
//   State<StatefulWidget> createState() {
//     return _VideoPlayerMaterialControlsState();
//   }
// }
//
// class _VideoPlayerMaterialControlsState
//     extends BetterPlayerControlsState<VideoPlayerMaterialControls> {
...
//                             widget.autoIcon,
//                             style: TextStyle(
//                               color: widget.enableAutoIcon?ColorConstant.white:
...
//                     _buildLiveWidget()
//                   else
//                     _controlsConfiguration.enableProgressText &&   !widget.isGeneral
...
//                   else
//                     const SizedBox(),
//                   if (_controlsConfiguration.enableFullscreen && !widget.isGeneral)
//                     _buildExpandButton()
//                   else
//                     const SizedBox(),
//                 ],
...
//               const SizedBox()
//             else
//               _controlsConfiguration.enableProgressBar && !widget.isGeneral
//                   ? _buildProgressBar()
//                   : const SizedBox(),
//           ],
//         ),
...
//       child: Center(
//         child: AnimatedOpacity(
//           opacity: controlsNotVisible ? 0.0 : 0.3,
//           duration: _controlsConfiguration.controlsHideTime,
...
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: [
//                 Text(_formatDuration(_betterPlayerController?.videoPlayerController?.value.position)),
//                 Expanded(
//                   child:
//
//                   SliderTheme(
...
//                     child:
//                     Slider(
//                       value: _betterPlayerController?.videoPlayerController?.value.position.inSeconds.toDouble()??0.0,
//                       min: 0,
//
//                       max: _betterPlayerController?.videoPlayerController?.value.duration?.inSeconds.toDouble()??0.0,
...
//                         setState(() {
//                           _betterPlayerController?.videoPlayerController?.position.then((duration) {
...
//                   ),
//                 ),
//                 Text(_formatDuration(_betterPlayerController?.videoPlayerController?.value.duration)),
//               ],
//             ),
//           ),
