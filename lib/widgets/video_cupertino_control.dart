...
class _CupertinoControlsState extends State<CupertinoControls>
  ...
  void initState() {
    ...
    if (widget.videoQualities.isNotEmpty) {
      ...
      selectedQuality.value =
          firstKey; // set your string value equal to the first key of the map
    }
  }
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: SizedBox(
            ...
            child: Center(
              child: Obx(
                () => globalController.selectedQuality.value == "360"
                    ? Text(
                        globalController.selectedQuality.value == "360"
                            ? globalController.selectedQuality.value
                            : "HD",
                        style: TextStyle(
                    ...
                    : Stack(
                        children: <Widget>[
                          // Create the text widget with a transparent border
                          Text(
                            globalController.selectedQuality.value == "360"
                                ? globalController.selectedQuality.value
                                : "HD",
                          ...
                          // Create the text widget with a solid color
                          Text(
                            globalController.selectedQuality.value == "360"
                                ? globalController.selectedQuality.value
                                : "HD",
  ...
  Widget _buildTopBar(
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          if (chewieController.allowFullScreen && !widget.isGeneral)
            _buildExpandButton(
              backgroundColor,
              iconColor,
              barHeight,
