        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                padding: getPadding(
                    bottom: index == cartlist!.length - 1 ? 65 : 8.0),
                child: Obx(() {
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              if (globalController.cartListRoute.value !=
                                  AppRoutes.tabsRoute) {
                              ...
                              Get.toNamed(
                                ...
                                parameters: {
                                  'tag': Uuid()
                                      .v4(), // Generate a unique tag for each item
                                },
                              )?.then((value) {
                                globalController
                                    .updateCurrentRout(Get.currentRoute);
                              });
                            ...
                            onLongPress: () {
                              controller.Products_to_delete.add(
                                  cartlist![index]);
                                    ...
                                    Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CustomImageView(
                                            ...
                                            image: cartlist![index].main_image,
                                          ),
                                        ) // mediaWidget(
          ...
          Obx(() {
            return controller.deleting_items.value
                ? Ui.circularIndicator(
                    color: MainColor, width: getSize(30), height: getSize(30))
                : SizedBox();
          })
        ],
      );
