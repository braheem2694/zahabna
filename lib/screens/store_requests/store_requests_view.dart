                              ...
                              children: [
                                          ...
                                          return MyCustomButton(
                                            ...
                                            onTap: () {
                                              Get.to(
                                                  ...
                                                  ?.then(
                                                (value) {
                                                  controller.requests[index].endDate = value;
                                ...
                                Obx(() {
                                  return MyCustomButton(
                                    ...
                                    fontSize: 14,
                                    height: 40,
                                    width: request.status.toLowerCase() == "deleted" || request.status.toLowerCase() == "cancelled" || request.status == 'Pending' ? getHorizontalSize(290) : getHorizontalSize(135),
                                    borderRadius: 10,
                                    padding: ButtonPadding.PaddingNone,
